...
object AppConfig {
    ...
    const val PREF_MANAGED_PER_APP_PROXY_SET = "pref_managed_per_app_proxy_set"
    const val PREF_MANAGED_PER_APP_PROXY_PREFIX_SET = "pref_managed_per_app_proxy_prefix_set"
    const val PREF_PER_APP_PROXY_USER_ADDED_SET = "pref_per_app_proxy_user_added_set"
    const val PREF_PER_APP_PROXY_USER_REMOVED_SET = "pref_per_app_proxy_user_removed_set"
    const val PREF_CLIENT_RULES_VERSION = "pref_client_rules_version"
    const val PREF_CLIENT_RULES_UPDATED_AT = "pref_client_rules_updated_at"
    const val PREF_CLIENT_RULES_TTL_SECONDS = "pref_client_rules_ttl_seconds"
    const val PREF_CLIENT_RULES_LAST_REFRESH_MS = "pref_client_rules_last_refresh_ms"
    const val PREF_CLIENT_RULES_LAST_APPLY_SOURCE = "pref_client_rules_last_apply_source"
    const val PREF_VSM_SPLIT_TUNNEL_DIAGNOSTICS = "pref_vsm_split_tunnel_diagnostics"
    ...
    /** VseMoiOnline-specific URLs. */
    const val VSM_APP_URL = "https://github.com/dmitry-ulyanichev/vsemoionline"
    const val VSM_TG_URL = "https://t.me/vsemoionline"
    const val VSM_PRIVACY_URL = "https://vmonl.store/privacy-policy"
